...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <meta name="author" content="NANCHO">
    <meta name="generator" content="NANCHO">
    <title>RR.HH</title>
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">HCDD</a>
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link d-flex align-items-center gap-2 active" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <svg class="bi"><use xlink:href="#people"/></svg>Personas
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li><button class="dropdown-item" type="button">
                    <a class="nav-link d-flex align-items-center gap-2" href="{{ route('padron') }}">
            ...
            <li class="nav-item">
              ...
              <ul class="dropdown-menu">
                ...
                <li><button class="dropdown-item" type="button">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('organigrama') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                      <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"/>
                    </svg>
                  Listado
            ...
            <li class="nav-item">
              ...
              <ul class="dropdown-menu">
                ...
                <li><button class="dropdown-item" type="button">
                  <a class="nav-link d-flex align-items-center gap-2" href="{{ route('justificaciones') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                      <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1z"/>
                    </svg>
                  Listado
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('acceso_registro')}}">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('grupos')}}">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{ route('proyectos') }}">
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="{{route('tablas')}}">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 " style="color:red;" href="#">
